...
test("Dever tentar criar um pedido vazio com CPF inválido", function(){
...
test("Dever criar um pedido com 3 itens com o cálculo do frete com a estratégia default", function(){
    const cpf = "839.435.452-10";
...
test("Dever criar um pedido com 3 itens com o cálculo do frete com a estratégia fixo", function(){
    const cpf = "839.435.452-10";
